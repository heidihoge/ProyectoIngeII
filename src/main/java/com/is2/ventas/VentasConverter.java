...
import com.is2.ventas.Ventas;
import com.is2.ventas.VentasFacade;
import com.is2.ventas.util.JsfUtil;
...
@FacesConverter(value = "ventasConverter")
public class VentasConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Ventas) {
            ...
            return getStringKey(o.getNroFactura());
        } else {
